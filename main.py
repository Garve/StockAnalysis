...
n_years = 5
print(f'Average annual dividend growth rate in the last {n_years} years was {dividend.get_growth_rate(n_years):.2%}')
...
print(f'There were {dividend.get_years_of_increase()} years of dividend non-decreases.')